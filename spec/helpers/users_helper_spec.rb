...
describe UsersHelper do
  ...
  describe "#show_action_button?" do
    context "should show delete button" do
      ...
      it { helper.show_action_button?(time_slot.start_time).should be_true }
    end
    ...
    context "should not show delete button" do
      ...
      it { helper.show_action_button?(time_slot.start_time).should_not be_true }
    end
  end
end
